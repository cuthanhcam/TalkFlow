...
&nbsp;   "DefaultConnection": "Server=(localdb)\\\\mssqllocaldb;Database=TalkFlowDDD;Trusted\_Connection=true;MultipleActiveResultSets=true"
...
\- Token chứa thông tin: user\_id, display\_name, roles
